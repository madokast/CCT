...
//        final double LENGTH = secondBend.DL2 + secondBend.CCT345_LENGTH + secondBend.GAP3;
        final double LENGTH = RUN_LENGTH;
        // ---------------- create magnet ----------------------
...
//        e = moveCCT345_1(e, FIRST_BEND, secondBend);
        ...
        e.addElement(FarIgnoreMagnet.create(
                moved1,
        ...
        // 拿到 COSY
        List<PhaseSpaceParticle> cosyBeforeQs3 = cosyParticleISOC();
...
//                    result.add(Math.abs(pc.x - pt.x)/MM);
//                    result.add(Math.abs(pc.y - pt.y)/MM);
                });
