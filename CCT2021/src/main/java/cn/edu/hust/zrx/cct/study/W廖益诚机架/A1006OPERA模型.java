...
public class A1006OPERA模型 {
    ...
    private GantryData.SecondPart secondPart() {
        ...
        secondPart.agCct345SmallRInner = 69 * MM; // +30 mm
        secondPart.agCct345SmallROuter = 79 * MM;
        secondPart.dipoleCct345SmallRInner = 89 * MM;
        secondPart.dipoleCct345SmallROuter = 99 * MM;
...
//        Plot3d.showThread();
    ...
    public void 四极磁场验证() {
        ...
        List<Point2> in = innerCct.magnetGradientAlongTrajectoryFast(trajectory, MM, 10 * MM);
    ...
    public static void main(String[] args) throws Exception {
        A1006OPERA模型 a = new A1006OPERA模型();
        a.opera_agCctInner();
        a.opera_agCctOuter();
