...
//        Plot2d.plot2(mm2mmm(x));
    ...
    public void 调整二极CCT四极场() {
        ...
        //    public double dipoleCct12A1Inner = Math.pow(dipoleCct12SmallRInner, 2) * 0.225;
        //    public double dipoleCct12A1Outer = -Math.pow(dipoleCct12SmallROuter, 2) * 0.225;
...
//        Plot2d.info("s/m","mm","Y方向",18);
    ...
    public void 不同四极CCT电流下单粒子() {
        ...
        //    public double agCct345IInner = 7811; // 9799 // 2020年6月11日 *0.995
...
//        Plot2d.info("x/mm", "xp/mrad", "x-plane", 18);
    ...
    public void 不同六极场分量大小对相椭圆影响() {
        //public double QS3_SECOND_GRADIENT = -87.25 * 2.0 / 2.0; //T m-2
    ...
    public void 不同QS3四极极场分量大小对相椭圆影响() {
        //  public double QS3_GRADIENT = -11.78; //T m-1
        //public double QS3_SECOND_GRADIENT = -87.25 * 2.0 / 2.0; //T m-2
...
//        agCct345.plot3(BaseUtils.ArrayUtils.repeat(6, ",'b',linewidth=0.1,alpha=0"));
    ...
    public void 参数() {
        //public double dipoleCct345A0Inner = -dipoleCct345SmallRInner * Math.sqrt(3) / dipoleCct345BigR;
    ...
    public void agcct345(){
        ...
        Line2 trajectoryPart2 = getTrajectoryPart2().resetLength(DL2+CCT345_LENGTH + GAP3 + QS3_LEN + GAP3);

        List<Point2> bz = elementsOfAllPart2.magnetGradientAlongTrajectoryFast(trajectoryPart2,10*MM,10*MM);
    ...
    public List<List<Point2>> phase相椭圆研究(
            double distance, boolean xPlane, double delta, int numberParticleForTrack,
            boolean moveToCenter, double scaleForParticle,
            MagnetAble magnetAble, Line2 trajectory,
    ...
    public List<Point2> tracking相椭圆(
    ...
    public List<Point2> trackingIdealParticle(
    ...
    public List<Point3> trackingIdealParticle(Line2 trajectory, double distance, MagnetAble magnetAble) {
        RunningParticle ip = ParticleFactory.createIdealProtonAtTrajectory250MeV(trajectory);
        return ParticleRunner.run(ip, magnetAble, distance, MM);
    }

    // 单位 m-m
    public List<List<Point2>> track多粒子(int number, double delta, Line2 trajectory, double distance,
...
//        List<RunningParticle> ps = ParticleFactory.createParticlesFromPhaseSpaceParticle(ip, ip.computeNaturalCoordinateSystem(), pp);
    ...
    public List<List<Point3>> track多粒子3d(int number, double delta, Line2 trajectory,
...
//        List<RunningParticle> ps = ParticleFactory.createParticlesFromPhaseSpaceParticle(ip, ip.computeNaturalCoordinateSystem(), pp);
    ...
    // 画图时 单位转为 m-mm
    public void track多粒子并画图(int number, double delta, Line2 trajectory, double distance,
                             MagnetAble magnetAble, boolean xPlane) {
    ...
    // 单位 mm/%
    public List<Point2> track色散(Line2 trajectory, MagnetAble magnetAble) {
    ...
    // 单位 mm/%
    public List<Point2> cosy色散(List<BaseUtils.Content.BiContent<Double,
     ...
     * @return 函数关系 y=f(x)
     */
    public List<Point2> trackFunction(
    ...
    public List<Point2> mm2mmm(List<Point2> mm) {
        return Point2.convert(mm, 1, 1 / MM);
    }

    // ---------- element --------------

    public Trajectory getTrajectoryPart2() {
        Trajectory trajectoryPart1 = getTrajectoryPart1();
    ...
    public Trajectory getTrajectoryPart1() {
    ...
    public static Trajectory getTestTrajectory(double BigR, double angle, double driftLength) {
    ...
    public Elements getElementsOfAllPart1() {
    ...
    public MagnetAble getElementsOfAllPart2() {
        Trajectory trajectoryPart2 = getTrajectoryPart2();
    ...
    public List<QsHardPlaneMagnet> getQs12() {
        Trajectory trajectoryPart1 = getTrajectoryPart1();
    ...
    public QsHardPlaneMagnet getQs3() {
        Trajectory trajectoryPart2 = getTrajectoryPart2();
...
//        boolean directθInner, boolean directθOuter
    ...
    public final BaseUtils.Timer timer = new BaseUtils.Timer();
    ...
    // 磁钢度
    public final double Bp = 2.43213;

    // QS 123
    public double QS1_GRADIENT = 28.33; //T m-1
    public double QS2_GRADIENT = -12.12; //T m-1
    public double QS3_GRADIENT = -11.78; //T m-1

    // 注意，六极场梯度一直存在错误，实际值应该乘二。由陈庚发现于 2020年5月26日
    public double QS1_SECOND_GRADIENT = -140.44 * 2.0 / 2.0; //T m-2
    public double QS2_SECOND_GRADIENT = 316.22 * 2.0 / 2.0; //T m-2
    public double QS3_SECOND_GRADIENT = -87.25 * 2.0 / 2.0; //T m-2
    ...
    // 偏转半径
    public final double trajectoryBigRPart1 = 0.95;
    public final double trajectoryBigRPart2 = 0.95;
    public final double dipoleCct12BigR = 0.95;
    public final double dipoleCct345BigR = 0.95;
    ...
    public double agCct12StartingθInner = 0.0; // 起始绕线方向
    ...
    public double agCct345StartingθInner = 0.0; // 起始绕线方向
    ...
    // CCT孔径
    public final double agCct12SmallRInner = 23.5 * MM;
    public final double agCct12SmallROuter = 33.5 * MM;
    public final double dipoleCct12SmallRInner = 43 * MM;
    public final double dipoleCct12SmallROuter = 52 * MM;
    ...
    public final double agCct12A0Inner = 0.0;
    public final double agCct12A0Outer = 0.0;
    public final double agCct12A1Inner = -Math.pow(agCct12SmallRInner, 2) * Math.sqrt(3) * 20;
    public final double agCct12A1Outer = Math.pow(agCct12SmallROuter, 2) * Math.sqrt(3) * 20;
    public final double agCct12A2Inner = 0.0;
    public final double agCct12A2Outer = 0.0;
    ...
    // 数组
    public double[] agCct345A0Inners = BaseUtils.ArrayUtils.repeat(0.0, 3);
    public double[] agCct345A0Outers = BaseUtils.ArrayUtils.repeat(0.0, 3);
    public double[] agCct345A1Inners = BaseUtils.ArrayUtils.repeat(-Math.pow(agCct345SmallRInner, 2) * Math.sqrt(3) * 20 * 0.19, 3);
    public double[] agCct345A1Outers = BaseUtils.ArrayUtils.repeat(Math.pow(agCct345SmallROuter, 2) * Math.sqrt(3) * 20 * 0.19, 3);
    public double[] agCct345A2Inners = BaseUtils.ArrayUtils.repeat(0.0, 3);
    public double[] agCct345A2Outers = BaseUtils.ArrayUtils.repeat(0.0, 3);

    //
    public final int dipoleCct12WindingNumber = 71;
    public final int agCctWindingNumber1 = 30;
    public final int agCctWindingNumber2 = 39; // sum = 69

    public final int dipoleCct345WindingNumber = 201;
    public final int agCctWindingNumber3 = 29;
    public final int agCctWindingNumber4 = 64;
    public final int agCctWindingNumber5 = 65;  // sum 158

    // CCT角度
    public final double dipoleCct12Angle = 22.5;
    public final double agCctAngle1 = 22.5 * agCctWindingNumber1 / (agCctWindingNumber1 + agCctWindingNumber2);//9.782608695652174
    public final double agCctAngle2 = 22.5 * agCctWindingNumber2 / (agCctWindingNumber1 + agCctWindingNumber2);//12.717391304347826

    public final double dipoleCct345Angle = 67.5;
    public final double agCctAngle3 = 67.5 * agCctWindingNumber3 / (agCctWindingNumber3 + agCctWindingNumber4 + agCctWindingNumber5); //12.389
    public final double agCctAngle4 = 67.5 * agCctWindingNumber4 / (agCctWindingNumber3 + agCctWindingNumber4 + agCctWindingNumber5); //27.3418
    public final double agCctAngle5 = 67.5 * agCctWindingNumber5 / (agCctWindingNumber3 + agCctWindingNumber4 + agCctWindingNumber5); //27.7690

    // 长度
    public final double DL1 = 0.825;
    public final double DL2 = 2.000;
    public final double QS1_LEN = 0.250;
    public final double QS2_LEN = 0.250;
    public final double QS3_LEN = 0.163;
    public final double GAP1 = 0.200;
    public final double GAP2 = 0.200;
    public final double GAP3 = 0.176;
    public final double BETWEEN_CCT225 = GAP1 * 2 + QS1_LEN * 2 + GAP2 * 2 + QS2_LEN;
    public final double CCT12_LENGTH = trajectoryBigRPart1 * BaseUtils.Converter.angleToRadian(dipoleCct12Angle);
    public final double CCT12_LENGTH_PART1 = trajectoryBigRPart1 * BaseUtils.Converter.angleToRadian(agCctAngle1);
    public final double CCT12_LENGTH_PART2 = trajectoryBigRPart1 * BaseUtils.Converter.angleToRadian(agCctAngle2);
    public final double CCT345_LENGTH = trajectoryBigRPart2 * BaseUtils.Converter.angleToRadian(dipoleCct345Angle);
    public final double CCT345_LENGTH_PART3 = trajectoryBigRPart2 * BaseUtils.Converter.angleToRadian(agCctAngle3);
    public final double CCT345_LENGTH_PART4 = trajectoryBigRPart2 * BaseUtils.Converter.angleToRadian(agCctAngle4);
    public final double CCT345_LENGTH_PART5 = trajectoryBigRPart2 * BaseUtils.Converter.angleToRadian(agCctAngle5);
    ...
    // CCT每匝分段
    public final int numberPerWinding = 360;
